...
new Vue({
    ...
    methods: {
         ...
         */
        update: function (obj) {
            this.fileAddress += obj + this.fileSeparator;
            this.listlimit();
        },
        /**
         * 返回上一级
         ...
         */
        returnFile: function () {
            this.fileAddress = this.fileAddress.substr(0, this.fileAddress.lastIndexOf(this.fileSeparator));
            this.fileAddress = this.fileAddress.substr(0, this.fileAddress.lastIndexOf(this.fileSeparator) + 1);
        ...
        deleteFile: function (id) {
            axios.get(this.apiurl + 'api/v2/db/delete',
                {
                    params: {
                        fileurl: this.fileAddress+this.fileSeparator+id,
                    }
                })
                .then(
                    (res) => {
    ...
    mounted() {
         ...
         * 获得分页详细列表
         */
        axios.get(this.apiurl + 'api/v2/supplierApply/getListByLimit',
            {
                params: {
                    state: '1',
