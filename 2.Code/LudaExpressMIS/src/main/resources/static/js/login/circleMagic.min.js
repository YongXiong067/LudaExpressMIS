...
;(function($){
    $.fn.circleMagic=function(options){
        ...
        let circles=[];
        let settings=$.extend({
            elem:'.header',color:'rgba(255,255,255,.4)',radius:20,densety:0.3,clearOffset:0.2
        },options);
        initContainer();
        addListeners();
        ...
        function Circle(){
            ...
            function init(){
                self.pos.x=Math.random()*width;self.pos.y=height+Math.random()*100;
